...
class FeedBackSecondScreen extends StatelessWidget {
  const FeedBackSecondScreen({super.key});
    ...
    return Scaffold(
      ...
      Column(
        ...
        children: [
          ...
          Text('Feedback ',style: style.copyWith(fontSize: 30,fontWeight: FontWeight.w800),),
